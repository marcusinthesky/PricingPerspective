...
title: Why finance needs vintage, reproducible encoders
summary: The design of the EttaX models and why a dated encoder should be treated as part of the information set in financial econometrics.
...
<figure className="blog-table">
  <table>
    <caption>Table 1. EttaX model vintages, source snapshots, and experimental roles.</caption>
    <thead>
      <tr>
        <th scope="col">Vintage</th>
        <th scope="col">Snapshot</th>
        <th scope="col">Experimental role</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <th scope="row">EttaX V0</th>
        <td><code>enwiki-20171220</code></td>
        <td>Zero-exposure floor</td>
      </tr>
      <tr>
        <th scope="row">EttaX V1</th>
        <td><code>enwiki-20201220</code></td>
        <td>Outcome-clean primary arm</td>
      </tr>
      <tr>
        <th scope="row">EttaX V3</th>
        <td><code>enwiki-20260801</code></td>
        <td>Maximum-exposure arm</td>
      </tr>
    </tbody>
  </table>
</figure>
...
<Callout title="The reproducibility rule">
Every model vintage gets its own tokenizer hash, corpus identifier, preparation manifest, checkpoint, configuration, metrics, and output path. A new corpus or recipe becomes a new vintage; it never overwrites an older scientific input.
</Callout>
